...
-- Drop conflicting signatures first
...
BEGIN
  ...
  -- Create Live Booking Request for nearby providers (Logic from fix_booking_schema)
...
DROP TRIGGER IF EXISTS prevent_invalid_booking_transitions ON public.bookings;
