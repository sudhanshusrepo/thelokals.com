-- ============================================
-- THELOKALS.COM - BIBLE ALIGNMENT SCHEMA
-- ============================================
-- Version: 1.1
-- Date: 2025-12-18
-- Description: Adds location hierarchy, pincode mapping, and enhanced service management.
-- ============================================
...
CREATE TABLE IF NOT EXISTS public.pincodes (
  ...
  GIST INDEX idx_pincodes_polygon (polygon)
);
...
RETURNS UUID AS $$
    ...
    AND ST_Contains(polygon, ST_SetSRID(ST_MakePoint(p_lng, p_lat), 4326))
