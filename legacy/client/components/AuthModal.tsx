...
interface AuthModalProps {
  onClose: () => void;
  defaultTab?: 'signin' | 'signup' | 'phone';
}

export const AuthModal: React.FC<AuthModalProps> = ({ onClose, defaultTab = 'signin' }) => {
  ...
  const [confirmationResult, setConfirmationResult] = useState<OTPConfirmation | null>(null);
  ...
  return (
    <div className="fixed inset-0 z-[60] flex items-center justify-center p-4 bg-slate-900/50 backdrop-blur-sm animate-fade-in" data-testid="auth-modal-overlay">
