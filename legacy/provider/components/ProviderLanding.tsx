        ...
        <div className="min-h-screen bg-gradient-to-b from-orange-50 to-white">
                ...
                <div className="relative max-w-7xl mx-auto px-4 py-16 sm:py-24">
                    <div className="text-center">
                        <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold text-slate-900 mb-6 tracking-tight">
                            ...
                            <span className="block text-orange-500 mt-2">thelokals</span>
                        </h1>
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                            <button
                                ...
                                className="px-8 py-4 bg-orange-500 text-white text-lg font-bold rounded-xl hover:bg-orange-600 transition-all transform hover:scale-105 shadow-lg hover:shadow-orange-500/25"
                            >
                                {user ? 'Complete Registration' : 'Get Started'}
                            </button>
                            <a
                                href="#how-it-works"
                                className="px-8 py-4 bg-white text-orange-600 text-lg font-bold rounded-xl hover:bg-orange-50 transition-all border-2 border-orange-100"
                            >
                                Learn More
                            </a>
                        </div>
                ...
                <div className="max-w-7xl mx-auto px-4">
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
                        <div>
                            ...
                            <div className="text-orange-100">Active Providers</div>
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <div className="text-orange-100">Earnings Paid</div>
                        </div>
                        <div>
                ...
                <div className="max-w-7xl mx-auto px-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        {features.map((feature, index) => (
                            <div
                                key={index}
                                className="bg-white border border-slate-100 rounded-2xl p-6 hover:shadow-xl transition-all transform hover:-translate-y-1 hover:border-orange-200"
                            >
                                <div className="text-5xl mb-4 bg-orange-50 w-20 h-20 flex items-center justify-center rounded-2xl">{feature.icon}</div>
                        ...
                        {[
                            ...
                            <div key={index} className="text-center group">
                                <div className="relative mb-6 inline-block">
                                    <div className="w-20 h-20 bg-white border-2 border-orange-100 text-orange-600 rounded-2xl flex items-center justify-center text-3xl font-bold mx-auto shadow-sm group-hover:border-orange-500 transition-colors">
                                        {item.step}
                                    </div>
                                    <div className="text-4xl absolute -bottom-2 -right-2 bg-orange-50 rounded-full p-1 border-2 border-white">{item.icon}</div>
                                </div>
                ...
                <div className="max-w-7xl mx-auto px-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 max-w-4xl mx-auto">
                        {benefits.map((benefit, index) => (
                            <div key={index} className="flex items-start gap-3 bg-orange-50/50 border border-orange-100/50 rounded-xl p-4 hover:bg-orange-50 transition-colors">
            ...
            <section className="py-20 bg-slate-900 text-white relative overflow-hidden">
                ...
                <div className="relative max-w-4xl mx-auto px-4 text-center">
                    ...
                    <button
                        onClick={handleGetStarted}
                        className="px-8 py-4 bg-orange-500 text-white text-lg font-bold rounded-xl hover:bg-orange-600 transition-all transform hover:scale-105 shadow-lg shadow-orange-500/25"
                    >
            ...
            <footer className="bg-slate-950 text-white py-12 border-t border-slate-900">
                <div className="max-w-7xl mx-auto px-4 text-center">
                    <div className="font-bold text-2xl mb-4">thelokals<span className="text-orange-500">.com</span></div>
