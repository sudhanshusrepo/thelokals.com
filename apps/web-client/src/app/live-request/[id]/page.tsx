...
import { supabase, liveBookingService } from '@thelocals/platform-core';
                ...
                <AnimatePresence mode="wait">
                    {requestStatus.status === 'broadcasting' && (
                        <motion.div
                            ...
                            className="mb-8"
                        >
                            <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-accent-amber/10 to-warning/10 border-2 border-accent-amber/30 p-8 bg-white/50">
                    ...
                    {(requestStatus.status === 'accepted' || requestStatus.status === 'en_route') && requestStatus.provider && (
                        ...
                        >
                            ...
                            <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-success/10 to-primary/10 border-2 border-success p-8 bg-white/50">
