...
const footerLinks = {
    services: [
        ...
        { label: 'Plumbing', href: '/service/plumbing' },
        { label: 'Electrician', href: '/service/electrician' },
        { label: 'Cleaning', href: '/service/cleaning' }
    ],
    company: [
        { label: 'About Us', href: '/about' },
        { label: 'Careers', href: '/careers' },
        { label: 'Blog', href: 'https://blogs.thelokals.com', external: true },
                    ...
                    <div className="flex flex-col md:flex-row items-center justify-between gap-6">
                        ...
                        <div className="text-center md:text-left">
                            <div className="flex items-center gap-2 justify-center md:justify-start mb-2">
                                ...
                                <span className="text-primary font-bold text-lg">lokals</span>
                            </div>
